...
const DB_INSERT_JPS = "INSERT INTO tb_asm_jps (key, id_session, id_record, title, date, type, horizontal, vertical, angular, current, duration) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
const DB_SELECT_BY_ID_JPS = "SELECT id, key, id_session, id_record, title, date, type, horizontal, vertical, angular, current, duration FROM tb_asm_jps WHERE id_session=?";

const DB_DELETE_BY_KEY_JPS = "DELETE FROM tb_asm_jps WHERE id_session = ?";
